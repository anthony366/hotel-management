  ...
  return (
    <section className="flex md:flex-row flex-col px-4 py-10 items-center gap-12 container mx-auto">
      ...
      <div className="md:py-10 md:w-1/2 text-left">
        <h3 className="font-heading mb-4 lg:mb-8">Featured Room</h3>
        ...
        <div className="flex flex-col mt-5">
          ...
          <Link
            ...
            className="border h-fit text-center border-tertiary-dark text-tertiary-dark px-3 py-2 lg:py-5 lg:px-7 rounded-md font-bold lg:text-xl xl:w-1/2"
          >
            More Details
          </Link>
        </div>
